...
export default function EditarScreen() {
  const [monto, setMonto] = useState("450.00");
  const [descripcion, setDescripcion] = useState("Supermercado La Esperanza");
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitulo}>Editar Transacción</Text>
      </View>

      <ScrollView style={styles.content}>
        <View style={styles.formContainer}>
          <View style={styles.transactionPreview}>
            <Ionicons name="cart" size={40} color="#2a6db0" />
            <View style={styles.previewInfo}>
              <Text style={styles.previewDescription}>{descripcion}</Text>
              <Text style={styles.previewDetails}>{categoria} • 15/03/2024</Text>
            </View>
            <Text style={[styles.previewAmount, styles.expenseAmount]}>-$450.00</Text>
          </View>

          <Text style={styles.formTitle}>Modificar Información</Text>
